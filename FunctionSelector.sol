 ...
 *
 * Take for a example, this code below. It uses call to execute transfer ona contract at the address addr
 * addr.call(abi.encodeWithSignature("transfer(address, uint256)",0xSomeAddress, 123 ));
 *
 * The first 4 bytes returned from abi.encodeWithSignature(...) is the function selector
 * Perhaps you can save a tiny amount of gas if you precompute and inline the function sleector in your code?
